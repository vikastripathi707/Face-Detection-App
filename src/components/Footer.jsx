...
function Footer() {
  return (
    <div className='mt-5 container-fluid bg-primary bg-gradient text-white footer' style={{minHeight:"12rem"}}>
     ...
     {   /* Defines 3 col for large section and medium and 1 col for small devices  */}
        ...
        <button className='btn btn-warning text-danger m-2 ' >Subscribe</button>
        ...
        <p><i className="px-1 fa-sharp fa-solid fa-location-dot"></i> 26,G.T, Road ,Jankipuram</p>
        <p>Lucknow</p>
